...
in
{
  options = {
    ...
    holoport.channels.nixpkgs = mkOption {
      type = types.str;
      # FIXME: final url
      default = "http://holoportbuild.holo.host/job/holoportOS/develop/channels.nixpkgs/latest/download/1";
      description = ''
    ...
    holoport.channels.holoport = mkOption {
      type = types.str;
      # FIXME: final url
      default = "http://holoportbuild.holo.host/job/holoportOS/develop/channels.holoport/latest/download/1";
      description = ''
